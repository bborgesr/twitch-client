...
function (_React$Component) {
  ...
  function Stream(props) {
    ...
    _this.state = {
      stream: props.stream // , loop: true }

    };
    _this.updateViewers = _this.updateViewers.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Stream, [{
    ...
    value: function componentDidMount() {
      // this.timerID = setInterval(this.updateStream, 1000)
      this.timerID = setInterval(this.updateViewers, 2000);
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      clearInterval(this.timerID); // this.setState({ loop: false })
    }
  }, {
    key: "updateViewers",
    value: function updateViewers() {
      var _this2 = this;
    ...
    value: function render() {
      ...
      // const viewers = stream === null ? 0 : stream.data[0].viewer_count
      // console.log(viewers)
      ...
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, this.state.stream.data[0].title), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "Viewers: " + this.state.stream.data[0].viewer_count), "//", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("button", {
        onClick: this.updateViewers
      }, "Refresh viewers"));
    }
  }], [{
    key: "getInitialProps",
...
//# sourceMappingURL=channel.js.2a2f6421f666e4b16f82.hot-update.js.map